...
| Documentation | Markdown samples — Annex IV + Article 13 |
...
- Article 15 robustness battery (4 checks, 1 open finding)
...
- **The boundary-sensitivity finding:** Our Article 15 test found a real problem — 27.6% of borderline decisions flipped under a 5% input perturbation. We're documenting it as open, not hiding it. Here's why honesty in compliance docs actually makes the document stronger.
